...
const ClientsList = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className="bg-primary h-48 rounded-b-full"></div>

            <div className="flex justify-center -mt-44 items-end space-x-10 ">

                {selectedClientIndex !== 0 && <i className="ri-arrow-left-line text-4xl text-gray-600 cursor-pointer hover:bg-gray-700" onClick={previous}></i>}
                    ...
                    {[clients[selectedClientIndex], clients[selectedClientIndex + 1], clients[selectedClientIndex + 2]].map(item => (
                        <div className="bg-white shadow p-5 w-[400px] h-[400px] border">
                            <div className="flex space-x-10 items-center justify-between">
                                ...
                                <img src={item.logo} className="h-32 w-32" />
                            </div>
                ...
                {selectedClientIndex < 4 && <i className="ri-arrow-right-line text-4xl text-gray-600 cursor-pointer hover:bg-gray-700" onClick={next}></i>}
            </div>
                ...
                <div className="flex space-x-2">
                    {[1, 2, 3, 4, 5].map((i, index) => (
                        <div
                            ...
                            className={`bg-gray-300 cursor-pointer h-4 w-4 rounded-full ${selectedClientIndex === index && 'border-2 border-secondary h-5 w-5'}`}>
